      ...
      <div className="create-account-page-wrapper">
        <div className="container">
          ...
          >
            ...
            <Typography color="textPrimary" style={{color:"#af4df1"}}>Create an Account</Typography>
          </Breadcrumbs>
                ...
                <form  onSubmit={handleSubmit}>
                  <div  className="form-block">
                    <div className="personal-information">
                      ...
                      <p>
                        Enter the following details to create your
                        account.
                      </p>
                      <div style={{alignItems:"center"}} className="form-row-wrapper">
